...
class CalendarClient {
  ...
  // for creating new calendar event
  Future<Map<String, String>> insert({
    ...
    try {
      await calendar.events
          .insert(event, calendarId, conferenceDataVersion : hasConferenceSupport ? 1 : 0, sendUpdates: shouldNotifyAttendees ? "all" : "none")
          .then((value) {
  ...
  // For patching an already-created calender event
